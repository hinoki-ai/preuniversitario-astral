      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid gap-8 md:grid-cols-3 lg:grid-cols-5 mb-8">
          {navigationSections.map((section, idx) => (
            <div key={idx}>
              <h4 className="mb-4 text-lg font-semibold text-accent">{section.title}</h4>
        ...
        <div className="flex items-center justify-between py-6 border-t border-border mb-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex h-4 w-32">
              ...
              <div className="bg-destructive h-full w-1/2"></div>
            </div>
            <a
        ...
        <div className="text-center border-t border-border pt-6">
          ...
          <div className="text-center text-muted-foreground text-xs">
            Desarrollado por{' '}
            <span className="font-mono text-lg tracking-wider text-accent">ΛRΛMΛC®</span>
          </div>
          <div className="flex justify-center items-center mt-2">
            ...
            />
            <span className="text-muted-foreground text-xs">Desarrollado con ❤️</span>
          </div>
        </div>
      </div>
    </footer>
