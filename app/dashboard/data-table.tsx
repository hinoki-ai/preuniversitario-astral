    ...
    <Drawer direction={isMobile ? "bottom" : "right"}>
      ...
      <DrawerContent>
        <DrawerHeader className="gap-1">
          ...
          <DrawerDescription>
            Mostrando visitantes totales en los últimos 6 meses
          </DrawerDescription>
        </DrawerHeader>
            ...
            <>
              ...
              <div className="grid gap-2">
                ...
                <div className="text-muted-foreground">
                  Mostrando visitantes totales en los últimos 6 meses. Esto es solo
                  un texto aleatorio para probar el diseño. Se extiende por varias líneas
                  y debería ajustarse.
                </div>
              </div>
              <Separator />
